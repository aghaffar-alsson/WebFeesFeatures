    ...
    <div className='bnkfrmcont' ref={formReff}>
      ...
      {/* <p className='frmtitle'>Fees Form for 2025-2026 - {schoolName}</p> */}
        ...
        <div className="hdr">
          ...
          <h5 className="graytxt">|********************************************Student Info.***************************************|</h5>
          ...
          <h5 className="evdd"><u>Amount: LE {instAm.toLocaleString("en-us")}</u></h5>
          <h5>ONLY {(numberToWords.toWords(instAm)).toUpperCase()} LE</h5>
          <hr></hr>
          <h5 className="graytxt">|***************************************Bank Details********************************************|</h5>
          ...
          <hr></hr>
          <h5 className="evdd">Please send the payment evidance to <strong><u>fees@alsson.com</u></strong></h5>
          <h5>|**************************************END OF FORM*****************************************|</h5>
          </div>
        </div>
